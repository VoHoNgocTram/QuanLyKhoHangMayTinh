...
WHERE manhomquyen = 7 AND machucnang = 'phieunhap' AND hanhdong = 'create' AND hanche = '[]';
DELETE FROM `chitietquyen`
WHERE manhomquyen = 2 AND machucnang = 'phieuxuat' AND hanhdong = 'create' AND hanche = '[]';
DELETE FROM `chitietquyen`
WHERE manhomquyen = 6 AND machucnang = 'nhanvien' AND hanhdong = 'update' AND hanche = '[]';
